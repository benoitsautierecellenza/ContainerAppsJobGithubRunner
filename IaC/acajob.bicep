...
param PARAM_ACR_NAME string = 'acrnprdab2cae523be'

@description('Azure Key Vault name')
param PARAM_KEYVAULT_NAME string = 'kvab2cae523be'

@description('GITHUB Image version')
param PARAM_RUNNER_IMAGE_VERSION string = '2.325.0' // Remplacer par '2.325.0' quand on veut utiliser la dernière version

@description('GitHub repository owner')
param PARAM_GITHUB_REPO_OWNER string = 'benoitsautierecellenza'

@description('GitHub repository name')
param PARAM_GITHUB_REPO_NAME string = 'containerappsjobgithubrunner'

@description('GitHub App ID')
param PARAM_GITHUB_APP_ID string = '1643445'

@description('GitHub App Installation ID')
param PARAM_GITHUB_APP_INSTALLATION_ID int = 76950829

var CONTAINER_APP_ENV_NAME = '${PARAM_ENVIRONMENT_NAME}-${PARAM_PROJECT_NAME}-acaenv'
var VAR_USERASSIGNEDIDENTITY_NAME = '${PARAM_ENVIRONMENT_NAME}-${PARAM_PROJECT_NAME}-uai' 
var ACR_LOGINSERVER = '${PARAM_ACR_NAME}.azurecr.io' 
...
var GITHUB_RUNNER_IMAGE_PATH = '${ACR_LOGINSERVER}/${GITHUB_RUNNER_IMAGE_NAME}:${PARAM_RUNNER_IMAGE_VERSION}' 
var ACCESS_TOKEN_API_URL = 'https://api.github.com/app/installations/${PARAM_GITHUB_APP_INSTALLATION_ID}/access_tokens' 
var GITHUB_REGISTRATION_TOKEN_API_URL = 'https://api.github.com/repos/${PARAM_GITHUB_REPO_OWNER}/${PARAM_GITHUB_REPO_NAME}/actions/runners/registration-token' 
var GITHUB_RUNNER_REGISTRATION_URL = 'https://github.com/${PARAM_GITHUB_REPO_OWNER}/${PARAM_GITHUB_REPO_NAME}' 
    ...
    containers: [
      {
        ...
        env: [
          ...
          { name: 'APP_ID', value: PARAM_GITHUB_APP_ID }
        ...
        rules: [
          {
            ...
            metadata: {
              owner: PARAM_GITHUB_REPO_OWNER
              repos: PARAM_GITHUB_REPO_NAME
              runnerScope: GITHUB_RUNNER_SCOPE
              targetWorkflowQueueLength: '1'
              applicationID: PARAM_GITHUB_APP_ID
              installationID: PARAM_GITHUB_APP_INSTALLATION_ID
            }
          }
        ]
      }
